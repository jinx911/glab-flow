...
const NODE_CONTENT: Record<string, { title: string; keys: string[] }> = {
  ...
  'story:开发中:测试中': { title: '提测说明', keys: ['自测计划', '接口自测覆盖', 'E2E结论', '测试范围', '改动点', '上线步骤A类', '上线步骤B类', '注意事项'] },
  'story:测试中:待发布': { title: '测试报告', keys: ['测试环境', '测试账号', 'reportId与环境', '请求与断言统计', 'Apifox资产状态', '回归详情', '阻塞问题及验证', 'featureMR评审详情', '发布建议'] },
  ...
  'bug:开发中:测试中': { title: '提测说明', keys: ['自测计划', '接口自测覆盖', 'E2E结论', '测试范围', '改动点', '上线步骤A类', '上线步骤B类', '注意事项'] },
  'bug:测试中:待发布': { title: '测试报告', keys: ['测试环境', '测试账号', 'reportId与环境', '请求与断言统计', 'Apifox资产状态', '回归详情', '阻塞问题及验证', 'featureMR评审详情', '发布建议'] },
